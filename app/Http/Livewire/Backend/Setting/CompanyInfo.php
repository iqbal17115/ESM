...
use App\Models\Backend\Setting\CompanyInfo as CompanyInfoData;
...
class CompanyInfo extends Component
{
    ...
    {
        $this->CompanyInfo  = CompanyInfoData::first();
        if ($this->CompanyInfo) {
    ...
    public function companyInfoSave()
    {
        ...
        $Query  = CompanyInfoData::first();
        if (!$Query) {
            $Query = new CompanyInfoData();
