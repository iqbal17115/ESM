...
use App\Models\Backend\Contact\ContactCategory as ContactCategoryInfo;
...
class ContactCategory extends Component
{
    ...
    {
        $this->contactCategoryDelete($this->DeleteId);
        $this->reset(['DeleteId']);
    ...
    {
        return view('livewire.backend.contact.contact-category');
    }
}
