        ...
        if ($result) {
            ...
            if ($productCard) {
                ...
                if (!($requestQuantity >= $result['min_order_qty'])) {
                    return [
                        'errorStatus' => true,
                        'message' => 'দুঃখিত স্যার,আপনি এই প্রডাক্টটি সর্বনিম্ন '.$result['min_order_qty'].' পিছ অর্ডার করতে পারবেন।',
                        'data' => [
                ...
                if (!$quantity) {
                    return [
                        'errorStatus' => true,
                        'message' => "দুঃখিত স্যার,আপনি এই প্রডাক্টটি 0 পিছ অর্ডার করতে পারবেন না!.",
                        'data' => [
                            'quantity' => 1,
                        ],
                        'errors' => [
