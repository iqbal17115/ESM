                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered mb-0 table-nowrap table-responsive-stack"
                                        ...
                                        <thead class="thead-light">
                                            <tr>
                                                <th>
                                                    SL <input name="bulk" type="checkbox" value="1"
                                                        wire:model.lazy="check_all" />
                                                </th>
                                                <th>Shop Name</th>
                                                <th>Customer Name</th>
                                                <th>Address</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    @if($check_all)
                                                    <input wire:model="servicios.{{ $processingOrder->id }}"
                                                        value="{{ $processingOrder->id }}" type="checkbox">
                                                    @endif
                                                ...
                                                <td>
                                                    @if($processingOrder->Contact)
                                                    {{$processingOrder->Contact->shipping_address}}
                                                    @endif
                                                </td>
                                                <td>
                                                    {{date('d F Y', strtotime($processingOrder->order_date))}}<br>
                                                    {{date('h:i A', strtotime($processingOrder->order_date))}}
                                                </td>
                                                <td>
