                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="control-label">Logo (141*29 PNG)
                                        @if (!$logo)
                                        @if($CompanyInfo)
                                        <img src="{{ asset('storage/photo/'.$CompanyInfo->logo)}}"
                            ...
                            <div class="col-lg-6">
                                <div wire:ignore class="form-group">
                                    ...
                                    <textarea class="form-control" id="privacy_policy" wire:model.lazy="privacy_policy"
                            ...
                            <div class="col-lg-6">
                                <div wire:ignore class="form-group">
                                    ...
                                    <textarea class="form-control" id="terms_condition"
                                        wire:model.lazy="terms_condition" placeholder="Terms & Condition"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div wire:ignore class="form-group">
                                    ...
                                    <textarea class="form-control" id="return_policy" wire:model.lazy="return_policy"
                            ...
                            <div class="col-lg-6">
                                <div wire:ignore class="form-group">
                                    ...
                                    <textarea class="form-control" id="about_us" wire:model.lazy="about_us"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" wire:model.lazy="google_map_location"
                                        placeholder="google_map_location"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <center>
                                  <button type="submit" class="btn btn-success w-lg waves-effect waves-light"
                                        wire:target="logo" wire:loading.attr="disabled">Update</button>
                                </center>
                            </div>
                        </div>
                    </div>
