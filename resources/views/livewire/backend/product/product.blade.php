                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div wire:ignore class="form-group">
                                        ...
                                        {{-- <textarea class="form-control" id="short_description" rows="3"
                                            ...
                                            wire:model.lazy="short_description" id="short_description"
                                            placeholder="Short Description"> {{$short_description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div wire:ignore class="form-group">
                                        ...
                                        {{-- <textarea class="form-control" id="long_description" rows="3"
                                            ...
                                            <textarea class="form-control" rows="3"
                                            wire:model.lazy="long_description" id="long_description" placeholder="Long Description"
                                            rows="8">{{$long_description}}</textarea>
                                    </div>
                                    <div wire:ignore class="form-group">
                                        ...
                                        {{-- <textarea class="form-control" id="key_word" rows="3"
                                            ...
                                            <textarea class="form-control" rows="3"
                                            wire:model.lazy="key_word" id="key_word" placeholder="Key Word"
                                            rows="8">{{$key_word}}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="metakeywords" name="manufacturername" type="text"
                                            class="form-control" wire:model.lazy="meta_keyword">
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#select2-dropdown2').on('change', function (e) {
            var data = $('#select2-dropdown2').select2("val");
            @this.set('sub_category_id', data);
        });
    });
    $(document).ready(function () {
        $('#select2-dropdown3').select2();
        $('#select2-dropdown3').on('change', function (e) {
            var data = $('#select2-dropdown3').select2("val");
            @this.set('sub_sub_category_id', data);
        });
    });
    $(document).ready(function () {
