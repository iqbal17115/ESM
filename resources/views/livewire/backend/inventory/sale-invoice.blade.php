                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <address>
                                            ...
                                            {{$SaleInvoice->Contact->business_name}}<br>
                                            ...
                                            <td rowspan="3" colspan="3" style="border: none;">
                                                ...
                                                <table class="table-info">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                           <td>@if($SalePayment->PaymentMethod) {{$SalePayment->PaymentMethod->name}} @endif</td>
                                                           <td>@if($SalePayment->PaymentMethod) {{$SalePayment->date}} @endif</td>
                                                           <td>
                                                            @if($currencySymbol)
                                                               {{ $currencySymbol->symbol }}
                                                            @endif
