            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        ...
                        @error('contact_id') <span class="error text-center">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-4"></div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <br>
                            ...
                            <button type="submit" class="btn btn-primary float-right" wire:click="Submit" style="width:150px;">Submit</button>
                    </div>
