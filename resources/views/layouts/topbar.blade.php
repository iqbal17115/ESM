        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="@if($companyInfo) {{ asset('storage/photo/'.$companyInfo->logo) }} @endif"
                        alt="Header Avatar">
                    {{-- <span class="d-none d-xl-inline-block ml-1">{{Auth::user()->name}}</span> --}}
                    <span class="d-none d-xl-inline-block ml-1">@if(isset($ProfileSettings)){{ $ProfileSettings->name }}@endif</span>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item d-block" href="{{route('user-management.user-list')}}"><span class="badge badge-success float-right">11</span><i class="bx bx-wrench font-size-16 align-middle mr-1"></i>Admin Settings</a>
                    @endif
